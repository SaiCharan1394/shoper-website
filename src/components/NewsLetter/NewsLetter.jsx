...
const NewsLetter = () => {
  return (
    <div className="w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 h-96 flex flex-col items-center justify-center mx-auto px-4 md:px-24 mb-16 bg-gradient-to-b from-purple-200 via-transparent to-green-100 gap-8">
