...
const Offers = () => {
  return (
    <div className=" w-full max-w-screen-2xl h-96 flex mx-auto px-4 md:px-24 mb-16 bg-gradient-to-b from-pink-100 to-green-100 mt-10">
      ...
      <div className=" justify-end items-center flex-1 hidden md:block p-8">
